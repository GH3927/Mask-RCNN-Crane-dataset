...
config = crane.craneInferenceConfig()
config.display()
...
# Load validation dataset
dataset = crane.craneDataset()
dataset.load_crane(DATASET_DIR, "test")
#dataset.load_crane(DATASET_DIR, "train")
...
weights_path = "C:/Mask_RCNN-master/logs/crane20190514T1112/mask_rcnn_crane_0107.h5"
...
# Test image
test_dir = os.path.join(DATASET_DIR, "test/rendering")
image_paths = []
